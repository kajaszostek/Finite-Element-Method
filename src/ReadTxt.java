...
public class ReadTxt {
    ...
    private int nH, nL, conductivity, c, ro, alpha, numberOfElements, numberOfPoints, numberOfPointsInColumn;
    ...
    public int getNumberOfPointsInColumn(){return numberOfPointsInColumn;}

    public void read() {

        File file = new File("C:\\Users\\Kaja\\IdeaProjects\\FEM\\src\\data.txt");
        Scanner in = null;
        try {
            in = new Scanner(file);
        ...
        numberOfElements = Integer.parseInt(in.nextLine());
        numberOfPoints = Integer.parseInt(in.nextLine());
        numberOfPointsInColumn = Integer.parseInt(in.nextLine());
    }
